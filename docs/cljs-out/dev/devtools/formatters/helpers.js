...
var G__9836 = devtools.prefs.pref.call(null,v);
v = G__9836;
continue;
} else {
return v;
...
}catch (e9839){var _e__8624__auto__ = e9839;
return false;
}})();
...
}catch (e9843){var _e__8624__auto__ = e9843;
return false;
}})();
...
}catch (e9845){var _e__8624__auto__ = e9845;
return false;
}}
}
});
...
var vec__9847 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9847,(0),null);
var name = cljs.core.nth.call(null,vec__9847,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9850_SHARP_);
}),template);
});
