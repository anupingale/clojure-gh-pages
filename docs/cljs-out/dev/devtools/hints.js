...
}catch (e14345){var _e = e14345;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___14348 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___14348)){
var seen_errors_14349 = temp__5455__auto___14348;
if(cljs.core.truth_(seen_errors_14349.has(self))){
} else {
seen_errors_14349.add(self);

var temp__5457__auto___14350 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___14350)){
var sense_14351 = temp__5457__auto___14350;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_14351)].join('');
} else {
}
}
} else {
