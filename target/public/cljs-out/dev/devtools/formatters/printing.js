...
var len__4730__auto___8999 = arguments.length;
var i__4731__auto___9000 = (0);
while(true){
if((i__4731__auto___9000 < len__4730__auto___8999)){
args__4736__auto__.push((arguments[i__4731__auto___9000]));

var G__9001 = (i__4731__auto___9000 + (1));
i__4731__auto___9000 = G__9001;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq8996){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8997,G__8998,seq8996__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9002_SHARP_){
return (!((cljs.core.meta.call(null,p1__9002_SHARP_) == null)));
})))){
...
var map__9003 = opts;
var map__9003__$1 = (((((!((map__9003 == null))))?(((((map__9003.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9003.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9003):map__9003);
var markup_db = cljs.core.get.call(null,map__9003__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9007){var _e__7945__auto__ = e9007;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e9009){var _e__7945__auto__ = e9009;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9011 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9012 = devtools.formatters.state.get_current_state.call(null);
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9012;

try{var map__9013 = opts;
...
var markup_db = cljs.core.get.call(null,map__9013__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9011;
}});
...
;
var temp__5733__auto___9018 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___9018)){
var managed_print_level_9019 = temp__5733__auto___9018;
var _STAR_print_level_STAR__orig_val__9016_9020 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9017_9021 = managed_print_level_9019;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9017_9021;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR__orig_val__9016_9020,_STAR_print_level_STAR__temp_val__9017_9021,managed_print_level_9019,temp__5733__auto___9018,writer,opts,job_fn){
return (function (p1__9015_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9015_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__9016_9020,_STAR_print_level_STAR__temp_val__9017_9021,managed_print_level_9019,temp__5733__auto___9018,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9016_9020;
}} else {
job_fn.call(null);
}
