...
var G__8970 = devtools.prefs.pref.call(null,v);
v = G__8970;
continue;
} else {
return v;
...
}catch (e8973){var _e__7945__auto__ = e8973;
return false;
}})();
...
}catch (e8977){var _e__7945__auto__ = e8977;
return false;
}})();
...
}catch (e8979){var _e__7945__auto__ = e8979;
return false;
}}
}
});
...
var vec__8981 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__8981,(0),null);
var name = cljs.core.nth.call(null,vec__8981,(1),null);
...
return cljs.core.some.call(null,(function (p1__8984_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__8984_SHARP_);
}),template);
});
