...
var o8865 = temp__5733__auto__;
var temp__5733__auto____$1 = (o8865["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o8866 = temp__5733__auto____$1;
return (o8866["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__7938__auto__ = f;
return (o__7938__auto__["toString"]).call(o__7938__auto__);
} else {
return "";
}
}catch (e8867){var _ = e8867;
return "";
}});
...
try{var o__7938__auto___8869 = t;
(o__7938__auto___8869["cljs$lang$ctorPrWriter"]).call(o__7938__auto___8869,t,writer);
}catch (e8868){var __8870 = e8868;
}
...
var char_code = (function (){var o__7938__auto__ = (new String(char$));
return (o__7938__auto__["charCodeAt"]).call(o__7938__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__7938__auto__ = String;
return (o__7938__auto__["fromCharCode"]).call(o__7938__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__8871 = num_code;
switch (G__8871) {
case (1):
return (185);
...
var o__7938__auto__ = String;
return (o__7938__auto__["fromCharCode"]).call(o__7938__auto__,superscript_code);
});
/**
...
}catch (e8873){var _e__7945__auto__ = e8873;
return false;
}})())){
...
var vec__8874 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__8874,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o8877 = temp__5733__auto__;
var temp__5733__auto____$1 = (o8877["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o8878 = temp__5733__auto____$1;
return (o8878["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__8881){
var vec__8882 = p__8881;
var ns_detector = cljs.core.nth.call(null,vec__8882,(0),null);
...
var G__8888 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__8889 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__8888;
remaining_tokens = G__8889;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq8879){
var G__8880 = cljs.core.first.call(null,seq8879);
var seq8879__$1 = cljs.core.next.call(null,seq8879);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8880,seq8879__$1);
});
...
var vec__8893 = cljs.core.split_with.call(null,(function (p1__8892_SHARP_){
return cljs.core.not_EQ_.call(null,p1__8892_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__8893,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__8893,(1),null);
...
var vec__8899 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__8899,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__8899,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__8902 = cljs.core.rest.call(null,remaining_tokens);
var G__8903 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__8902;
name_tokens = G__8903;
continue;
} else {
...
var vec__8906 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__8906,(0),null);
var arity = cljs.core.nth.call(null,vec__8906,(1),null);
var vec__8909 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__8909,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__8909,(1),null);
var vec__8912 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__8912,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__8912,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__8912,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__8912,(3),null);
...
var vec__8918 = result;
var munged_ns = cljs.core.nth.call(null,vec__8918,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__8918,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__8918,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__8918,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__8918,(4),null);
var arity = cljs.core.nth.call(null,vec__8918,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__8922 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__8922,(0),null);
var args = cljs.core.nth.call(null,vec__8922,(1),null);
var vec__8925 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__8925,(0),null);
var name = cljs.core.nth.call(null,vec__8925,(1),null);
...
var G__8928 = (arity + (1));
var G__8929 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__8930){
var vec__8931 = p__8930;
var arity = cljs.core.nth.call(null,vec__8931,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__8931,(1),null);
...
return cljs.core.get.call(null,arities,p1__8934_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__8935_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__8938){
var vec__8939 = p__8938;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__8939,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq8936){
var G__8937 = cljs.core.first.call(null,seq8936);
var seq8936__$1 = cljs.core.next.call(null,seq8936);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8937,seq8936__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__8947__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__8947__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__8947__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__8947__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__8948 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__8948,(0),null);
var fn_name = cljs.core.nth.call(null,vec__8948,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__8948,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__8948,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__8948,(4),null);
var arity = cljs.core.nth.call(null,vec__8948,(5),null);
...
var o__7938__auto__ = f;
return (o__7938__auto__["getBasis"]).call(o__7938__auto__);
});
/**
...
}catch (e8952){var _e__7945__auto__ = e8952;
...
var G__8953 = (obj[cljs.core.first.call(null,path)]);
var G__8954 = cljs.core.rest.call(null,path);
obj = G__8953;
path = G__8954;
continue;
} else {
...
return (function (accum,p__8955){
var vec__8956 = p__8955;
var bit = cljs.core.nth.call(null,vec__8956,(0),null);
var protocol = cljs.core.nth.call(null,vec__8956,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__8959){
var vec__8960 = p__8959;
var ns = cljs.core.nth.call(null,vec__8960,(0),null);
var name = cljs.core.nth.call(null,vec__8960,(1),null);
var selector = cljs.core.nth.call(null,vec__8960,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__8965,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__8965,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__8965,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__8963_SHARP_){
return (obj[cljs.core.first.call(null,p1__8963_SHARP_)]);
});})(name,sorted_matches,vec__8965,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
